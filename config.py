...
parser.add_argument('--recon_wei', type=float, default=0.1,
...
args.final_img_dir = join(args.root_dir, 'combined-georefrenced')  # Path to store the patched dataset

directories = ["models_dir", "logs_dir", "weights_dir", "layers_dir", "patch_dataset_dir", "tests_dir", "final_img_dir"]
